    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => firebaseClient.sendNotificationWithData("/topics/newEvent")}
                                  style={styles.button}>
                    <Text style={styles.buttonText}>Send Notification With Data to newEvent topic</Text>
                </TouchableOpacity>
            </View>
        );
    }
